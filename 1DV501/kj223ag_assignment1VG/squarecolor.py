...
def get_square_color(letter, number):
    if letter in 'aceg' and number % 2 == 1:    # all odd squares on aceg are black # noqa: E501
        return "Black"
    elif letter in 'bdfh' and number % 2 == 0:  # all even squeres on bdfh are black # noqa: E501
        return "Black"
...
# ensure that the input is in the correct format (letter+number, e.g., e5) and exists on the board # noqa: E501
if len(square_identifier) != 2 or not square_identifier[0] in 'abcdefgh' or not square_identifier[1] in '12345678':  # noqa: E501
